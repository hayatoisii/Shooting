...
// 地面(cube)・トゲ(Bullet)・ゴール(cube)タイルを描画する
...
private:
	...
	void AddTile(const TileMap& tileMap, int col, int row, std::vector<std::unique_ptr<KamataEngine::WorldTransform>>& transforms);
